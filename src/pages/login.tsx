          ...
          <div className="flex justify-center space-x-4">
            <button className="bg-white p-2 rounded-full shadow-md hover:shadow-lg transition-all">
              <svg className="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                ...
                <path d="M12.0001 24.0001C15.2401 24.0001 17.9651 22.935 19.9451 21.095L16.0801 18.095C15.0451 18.82 13.6751 19.25 12.0001 19.25C8.8701 19.25 6.21506 17.14 5.26506 14.295L1.27509 17.39C3.25009 21.31 7.31009 24.0001 12.0001 24.0001Z" fill="#34A853" />
              </svg>
            </button>
            ...
            <button className="bg-black p-2 rounded-full shadow-md hover:shadow-lg transition-all">
              <svg className="w-6 h-6 text-white" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512">
