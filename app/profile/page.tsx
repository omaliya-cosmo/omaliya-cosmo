...
import { Loader2, User, Shield, MapPin, Heart, Clock, LogOut, ChevronRight, Bell, BadgeHelp, Mail, Phone, CreditCard, Package, MessageSquare } from "lucide-react";
...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    if (tabFromUrl && ["settings", "security", "addresses", "wishlist", "orders", "notifications", "payments"].includes(tabFromUrl)) {
    ...
    <div className="w-full px-4 py-6 md:py-10 max-w-7xl mx-auto">
      ...
      <div className="mt-10 bg-gradient-to-br from-purple-50 via-white to-pink-50 rounded-lg border shadow-sm p-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-4">
          <div>
            <h3 className="text-lg font-medium">Need assistance with your account?</h3>
            <p className="text-muted-foreground mt-1">Our support team is here to help with any questions.</p>
          </div>
