  ...
  const benefits = [
    {
      ...
      description:
        "All ingredients are certified organic and sourced responsibly from trusted suppliers",
    ...
    },
    {
      ...
      title: "Cruelty-Free",
      description:
        "We never test on animals and are proudly certified by Leaping Bunny and PETA",
    ...
    },
    {
      ...
      description:
        "All products undergo rigorous testing by certified dermatologists for safety",
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-gray-600 text-lg md:text-xl mb-8">
              We believe in creating products that are good for you and the
              planet, without compromising on quality or efficacy.
            </p>
            ...
            >
              ...
              <div className="relative h-full backdrop-blur-sm bg-white/80 shadow-xl rounded-2xl p-8 border border-white/20 overflow-hidden flex flex-col">
                ...
                <div className="absolute -top-10 -right-10 w-40 h-40">
                  <div
                    className={`w-full h-full rounded-full ${benefit.bgLight} opacity-20 blur-xl`}
                  ></div>
                </div>
                ...
                <div className="relative mb-6 inline-block">
                  <div
                    className={`absolute inset-0 rounded-full bg-gradient-to-r ${benefit.color} blur-md opacity-20 group-hover:opacity-30 transition-opacity`}
                  ></div>
                  <div
                    className={`relative z-10 inline-flex items-center justify-center w-20 h-20 ${benefit.bgLight} text-gray-800 rounded-full mb-6 transition-all duration-300 transform group-hover:scale-110 group-hover:rotate-3`}
                  >
                    {benefit.icon}
                  </div>
                </div>
              ...
              <div className="flex flex-col md:flex-row items-center justify-between">
                <div className="mb-8 md:mb-0 md:w-2/3 md:pr-12">
                  ...
                  <p className="text-gray-700 text-lg leading-relaxed mb-6">
                    We're committed to quality, transparency, and delivering
                    products that fit seamlessly into your lifestyle. At
                    Omaliya, we believe shopping should be simple, inspiring,
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                    {[
                      {
                        text: "Certified Clean Beauty",
                        icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z",
                      },
                      {
                        text: "Ethical Ingredients",
                ...
                <div className="md:w-1/3 flex flex-col items-center">
                  ...
                  <div className="relative w-64 h-64 mb-8">
                    ...
                    <div className="absolute inset-0 transform rotate-3 bg-white rounded-3xl overflow-hidden border-2 border-purple-100 shadow-lg">
                      <Image
                        src="https://res.cloudinary.com/omaliya/image/upload/v1745202601/commitment_xuomgz.png"
        ...
        >
          ...
          <div className="flex flex-wrap justify-center items-center gap-8 md:gap-12 opacity-70">
            {[
              {
                src: "https://res.cloudinary.com/omaliya/image/upload/v1745200861/logo1_ggfx7z.jpg",
                alt: "Handiyan Certified",
              },
              {
                src: "https://res.cloudinary.com/omaliya/image/upload/v1745200861/logo2_qi6nho.webp",
                alt: "Roushun Approved",
              },
              {
                src: "https://res.cloudinary.com/omaliya/image/upload/v1745200862/logo4_b7aict.png",
                alt: "Delofil Certified",
              },
              {
                src: "https://res.cloudinary.com/omaliya/image/upload/v1745200862/logo5_gyibt4.jpg",
                alt: "Hikari Organic",
              },
              {
                src: "https://res.cloudinary.com/omaliya/image/upload/v1745200862/logo3_i4stlx.png",
                alt: "Karseel Certified",
              },
            ].map((logo, i) => (
              <motion.div
                key={i}
