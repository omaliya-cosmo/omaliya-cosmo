...
export default function CategoriesSection() {
  ...
  return (
    <section className="py-16 bg-gradient-to-b from-white to-purple-50" ref={ref} id="categories">
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <h2 className="text-2xl md:text-4xl font-bold text-gray-800 mb-4 leading-tight relative z-10">
            Shop By <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-600 to-pink-500">Category</span>
          </h2>
          <p className="text-gray-600 max-w-2xl mx-auto relative z-10">
            Discover our specially curated categories designed to meet all your beauty needs. 
            From skincare to makeup, we've got you covered.
          </p>
        </motion.div>
        ...
        {error && (
          ...
          >
            ...
            <p className="text-sm text-red-600 mb-6">We're having trouble loading the categories. Please try again.</p>
            <button 
              onClick={handleRetry}
...
function CategoryCard({ category, index, isHovered, onHover, onLeave }) {
    ...
    >
      ...
      >
        <div className="relative aspect-square">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 text-white transform transition-all duration-500 z-10">
            ...
            <div className="mt-4 transform opacity-0 translate-y-4 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
              <span className="inline-flex items-center text-sm font-medium text-white bg-purple-500/70 hover:bg-purple-600/90 backdrop-blur-sm rounded-lg px-4 py-2 transition-colors">
                Browse Products
                <svg className="ml-1.5 w-4 h-4 animate-pulse" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className={`absolute inset-0 bg-gradient-to-tr from-purple-600/20 to-pink-500/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none`}></div>
