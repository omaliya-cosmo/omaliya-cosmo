...
// Add debugging handlers for other HTTP methods
export async function PUT(request: NextRequest) {
  console.log("🔔 OnePay callback received - PUT method");
  console.log("📋 PUT request details:", {
    url: request.url,
    headers: Object.fromEntries(request.headers.entries()),
  });
  return NextResponse.json(
    { success: false, error: "PUT method not supported for OnePay callback" },
    { status: 405 }
  );
}

export async function PATCH(request: NextRequest) {
  console.log("🔔 OnePay callback received - PATCH method");
  return NextResponse.json(
    { success: false, error: "PATCH method not supported for OnePay callback" },
    { status: 405 }
  );
}

export async function DELETE(request: NextRequest) {
  console.log("🔔 OnePay callback received - DELETE method");
  return NextResponse.json(
    {
      success: false,
      error: "DELETE method not supported for OnePay callback",
    },
    { status: 405 }
  );
}
...
export async function OPTIONS(request: NextRequest) {
  console.log("🔔 OnePay callback received - OPTIONS method");
  return NextResponse.json(
    { success: true },
    {
      status: 200,
