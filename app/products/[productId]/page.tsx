...
export default function ProductDetailPage() {
  ...
  if (loading) {
    return (
      <div className="container mx-auto px-4 sm:px-6 lg:px-24 py-8 sm:py-12 lg:py-16">
        <div className="animate-pulse">
          <div className="h-6 sm:h-8 bg-gray-200 rounded w-2/3 sm:w-1/3 mb-4 sm:mb-6"></div>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 lg:gap-10">
            <div className="h-64 sm:h-80 md:h-96 bg-gray-200 rounded"></div>
            <div>
              <div className="h-8 sm:h-10 bg-gray-200 rounded w-full sm:w-3/4 mb-4 sm:mb-6"></div>
              ...
              <div className="h-3 sm:h-4 bg-gray-200 rounded mb-6 sm:mb-8 w-4/6"></div>
              <div className="h-10 sm:h-12 bg-gray-200 rounded mb-4 sm:mb-6 w-1/2 sm:w-1/3"></div>
