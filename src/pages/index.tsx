  ...
  const fetchCartData = async () => {
    try {
      ...
      if (res.ok) {
        ...
        // Sum total quantity of items in cart
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <header className="bg-white shadow-sm sticky top-0 z-50">
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex justify-between items-center">
            ...
            <Link href="/" className="flex items-center">
              ...
              <span className="ml-1 text-xs text-gray-500 hidden sm:inline-block">COSMETICS</span>
            </Link>
            ...
            <nav className="hidden md:flex items-center space-x-6">
              ...
              {/* Cart Icon */}
              <Link href="/cart" className="text-gray-700 hover:text-purple-600 relative group">
                ...
                <div className="absolute right-0 mt-2 w-48 bg-white rounded-md shadow-lg overflow-hidden z-20 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 transform origin-top-right">
                  {session ? (
                    <div className="py-2">
                      ...
                      <Link href="/api/auth/signout" className="block px-4 py-2 text-sm text-gray-700 hover:bg-purple-50">
                        Sign Out
                      </Link>
                    </div>
                  ) : (
        ...
        {/* Mobile Menu */}
        <div className={`md:hidden bg-white shadow-lg absolute w-full transition-all duration-300 ease-in-out ${isMenuOpen ? 'max-h-96' : 'max-h-0 overflow-hidden'}`}>
          <div className="container mx-auto px-4 py-2">
            <nav className="flex flex-col space-y-4 py-4">
              <Link href="/products" className="text-gray-700 hover:text-purple-600 font-medium py-2">
                Shop
              </Link>
              <Link href="/categories" className="text-gray-700 hover:text-purple-600 font-medium py-2">
                Categories
              </Link>
              <Link href="/about" className="text-gray-700 hover:text-purple-600 font-medium py-2">
                About
              </Link>
              <Link href="/contact" className="text-gray-700 hover:text-purple-600 font-medium py-2">
                Contact
              </Link>
              ...
              <div className="border-t border-gray-200 my-2 pt-2">
                {session ? (
                  <>
                    <Link href="/profile" className="text-gray-700 hover:text-purple-600 font-medium py-2 block">
                      Your Profile
                    </Link>
                    <Link href="/orders" className="text-gray-700 hover:text-purple-600 font-medium py-2 block">
                      Your Orders
                    </Link>
                    <Link href="/api/auth/signout" className="text-gray-700 hover:text-purple-600 font-medium py-2 block">
                      Sign Out
                    </Link>
                  </>
                ) : (
                  <>
                    <Link href="/login" className="text-gray-700 hover:text-purple-600 font-medium py-2 block">
                      Sign In
                    </Link>
                    <Link href="/register" className="text-gray-700 hover:text-purple-600 font-medium py-2 block">
                      Create Account
                    </Link>
                  </>
                )}
      ...
      <main className="flex-grow">
        ...
        <section className="relative bg-gradient-to-r from-purple-900 via-purple-800 to-purple-900 text-white">
          ...
          <div className="container mx-auto px-4 py-16 md:py-24 relative z-10">
            <div className="max-w-xl">
              <h1 className="text-4xl md:text-5xl font-bold mb-4">Discover Your Natural Beauty</h1>
              <p className="text-lg md:text-xl opacity-90 mb-8">
                Premium cosmetics and beauty products for the modern woman. Explore our exclusive collections.
              </p>
              <div className="flex space-x-4">
                <Link href="/products" className="bg-white text-purple-800 px-6 py-3 rounded-full font-semibold hover:bg-gray-100 transition-colors shadow-lg">
                  Shop Now
                </Link>
                <Link href="/new-arrivals" className="bg-transparent border-2 border-white text-white px-6 py-3 rounded-full font-semibold hover:bg-white hover:text-purple-800 transition-colors">
                  New Arrivals
                </Link>
              </div>
            </div>
        ...
        <section className="py-12 md:py-16 bg-gray-50">
          <div className="container mx-auto px-4">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
              {['Skincare', 'Makeup', 'Haircare', 'Fragrances'].map((category) => (
                <Link href={`/categories/${category.toLowerCase()}`} key={category} className="group">
                ...
                {products.slice(0, 8).map((product) => (
                  <div key={product._id} className="bg-white rounded-lg shadow-sm overflow-hidden group hover:shadow-md transition-shadow">
                    ...
                    <div className="p-4">
                      ...
                      <p className="text-gray-500 text-sm mb-2">{product.category_id || 'Cosmetics'}</p>
                      <div className="flex justify-between items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Guaranteed original products</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">Multiple payment methods</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="py-12 md:py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-8 text-center">New Season Collection</h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-gradient-to-r from-pink-100 to-pink-200 rounded-lg p-8 relative overflow-hidden">
                <div className="relative z-10">
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">Spring Glow</h3>
                  <p className="text-gray-600 mb-4">Lightweight formulas for a fresh look</p>
                  <Link href="/collections/spring" className="inline-block bg-white text-pink-600 px-6 py-2 rounded-full font-medium hover:bg-pink-600 hover:text-white transition-colors">
                    Shop Now
                  </Link>
                </div>
              ...
              <div className="bg-gradient-to-r from-blue-100 to-purple-100 rounded-lg p-8 relative overflow-hidden">
                <div className="relative z-10">
                  <h3 className="text-2xl font-bold text-gray-800 mb-2">Luxury Essentials</h3>
                  <p className="text-gray-600 mb-4">Premium products for your daily routine</p>
                  <Link href="/collections/essentials" className="inline-block bg-white text-purple-600 px-6 py-2 rounded-full font-medium hover:bg-purple-600 hover:text-white transition-colors">
                    Shop Now
                  </Link>
                </div>
                <div className="absolute right-0 bottom-0 opacity-30 transform translate-x-8 translate-y-8">
              ...
              {[
                {
                  name: "Sarah J.",
                  role: "Makeup Artist",
                  comment: "I've been using Omaliya products for my clients and myself. The quality is exceptional and the prices are reasonable."
                },
                {
                  name: "Emma T.",
                  role: "Regular Customer",
                  comment: "I love how these products are gentle on my sensitive skin. The skincare line has transformed my routine completely!"
                },
                {
                  name: "Michelle K.",
                  role: "Beauty Blogger",
                  comment: "Omaliya stands out with their commitment to quality. Their customer service is outstanding and products arrive beautifully packaged."
                }
        ...
        <section className="py-12 md:py-16 bg-purple-700 text-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-purple-200 mb-8 max-w-xl mx-auto">Subscribe to our newsletter for exclusive offers, beauty tips, and first access to new product launches.</p>
        ...
        <div className="container mx-auto px-4 py-12">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="text-gray-400 mb-4">Premium beauty products imported from around the world, bringing you the best in cosmetics and skincare.</p>
              <div className="flex space-x-4">
                ...
                <a href="#" className="text-gray-400 hover:text-white">
                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22.675 0h-21.35c-.732 0-1.325.593-1.325 // filepath: c:\Users\Dell\Desktop\omaliya-cosmo\src\pages\index.tsx
0 1.325 1.325v21.351c0 .732.593 1.325 1.325 1.325h21.351c.732 0 1.325-.593 1.325-1.325v-21.351c0-.732-.593-1.325-1.325-1.325zm-14.75 22h-3v-9h3v9zm-1.5-10.25c-.966 0-1.75-.784-1.75-1.75s.784-1.75 1.75-1.75 1.75 .784 1.75 1.75-.784 1.75-1.75 1.75zm13 10.25h-3v-4c0-.966-.784-2-2-2s-2 .784-2 2v4h-3v-9h3v2c0 .966 .784 2 2 2s2-.784 2-2v-2h3v9z"/>
                ...
                <p className="text-gray-400 text-sm">&copy; 2023 Omaliya. All rights reserved.</p>
                </div>
            </div>
            </div>
        </footer>
...
// Add this to your CSS (globals.css) or use as a Tailwind plugin
// @keyframes entrance {
