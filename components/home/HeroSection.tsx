        ...
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            ...
            <motion.p 
              ...
              variants={fadeIn}
            >
              Organic skincare products crafted with natural ingredients for a healthier, more vibrant you. Embrace beauty that comes from nature.
            </motion.p>
            ...
            >
              <div className="flex items-center mb-2">
                ...
                <span className="ml-2 text-sm text-gray-600">4.9/5 from 2,800+ reviews</span>
              </div>
              <p className="text-sm italic text-gray-600">
                "These products transformed my skin in just a few weeks. Can't imagine my routine without them!"
              </p>
                  ...
                  >
                    <div className="flex items-center">
                      <div className="flex-1">
                        <h3 className="text-sm font-bold text-gray-900">Miracle Glow Serum</h3>
                      ...
                      <div className="text-right">
                        ...
                        <div className="text-xs text-gray-500 line-through">$34.99</div>
                      </div>
                    </div>
