...
const ProfileNotifications: React.FC = () => {
  ...
  >([
    {
      ...
      title: "Order updates",
      description:
        "Receive notifications about your orders status and delivery updates",
      email: true,
      push: true,
      sms: false,
    },
  ...
  const [notifications, setNotifications] = useState<NotificationItem[]>([
    ...
    },
    {
      ...
      title: "Special offer",
      message:
        "Enjoy 25% off on all skincare products this weekend. Use code: SKINCARE25",
    ...
    },
    {
      ...
      message:
        "Your account password was recently changed. If you didn't make this change, please contact customer support.",
              ...
              >
                <div className="overflow-x-auto pb-2">
                  <TabsList className="w-full justify-start">
                    <TabsTrigger
                      value="all"
                      className="data-[state=active]:bg-purple-600/10 data-[state=active]:text-purple-700"
                    >
                      All
                    </TabsTrigger>
                    <TabsTrigger
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor="immediate">
                      Send immediately (as they happen)
                    </Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem
              ...
              <div>
                <div className="flex items-center justify-between mb-4">
                  ...
                  <div className="flex text-sm">
                    <span className="w-20 text-center font-medium text-purple-600">
                      Email
                    </span>
                    <span className="w-20 text-center font-medium text-purple-600">
                      Push
                      ...
                      <div className="flex gap-4">
                        <div className="w-20 flex justify-center">
                          <Switch
                            ...
                            onCheckedChange={() =>
                              toggleNotificationChannel(preference.id, "email")
                            }
                        ...
                        <div className="w-20 flex justify-center">
                          <Switch
                            ...
                            onCheckedChange={() =>
                              toggleNotificationChannel(preference.id, "push")
                            }
                            className="data-[state=checked]:bg-purple-600"
                          />
                        </div>
                        <div className="w-20 flex justify-center">
                          <Switch
                            ...
                            onCheckedChange={() =>
                              toggleNotificationChannel(preference.id, "sms")
                            }
                            className="data-[state=checked]:bg-purple-600"
                          />
                        </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-purple-700 mt-1">
                      ...
                      time. Account-related notifications for security and order
